package net.myndmelt.better_minecraft.item.custom;
...
public class ModHoeItem extends MiningToolItem {
    /**
    ...
    public ModHoeItem(ToolMaterial material, float attackDamage, float attackSpeed, Item.Settings settings) {
