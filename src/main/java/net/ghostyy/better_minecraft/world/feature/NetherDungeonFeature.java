...
public class NetherDungeonFeature extends Feature<DefaultFeatureConfig> {
    ...
    public NetherDungeonFeature(Codec<DefaultFeatureConfig> codec) {
        super(codec);
    }
    ...
    public boolean generate(FeatureContext<DefaultFeatureConfig> context) {
                ...
                for (u = p; u <= q; ++u) {
                    ...
                    if (s == k || t == -1 || u == p || s == l || t == 4 || u == q) {
                        ...
                        if (t == -1 && random.nextInt(4) != 0) {
                            this.setBlockStateIf(structureWorldAccess, blockPos2, Blocks.GILDED_BLACKSTONE.getDefaultState(), predicate);
                            continue;
                        }
                        this.setBlockStateIf(structureWorldAccess, blockPos2, Blocks.NETHER_BRICKS.getDefaultState(), predicate);
                        continue;
                    }
        ...
        block6: for (s = 0; s < 2; ++s) {
            for (t = 0; t < 3; ++t) {
                ...
                LootableContainerBlockEntity.setLootTable(structureWorldAccess, random, blockPos3, LootTables.BASTION_OTHER_CHEST);
                continue block6;
            }
        }
