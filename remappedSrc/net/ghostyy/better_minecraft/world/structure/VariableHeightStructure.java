package net.ghostyy.better_minecraft.world.structure;
...
public class VariableHeightStructure extends Structure {

    // A custom codec that changes the size limit for our code_structure_sky_fan.json's config to not be capped at 7.
    // With this, we can have a structure with a size limit up to 30 if we want to have extremely long branches of pieces in the structure.
    public static final Codec<VariableHeightStructure> CODEC = RecordCodecBuilder.<VariableHeightStructure>mapCodec(instance ->
            instance.group(VariableHeightStructure.configCodecBuilder(instance),
            ...
            ).apply(instance, VariableHeightStructure::new)).codec();
    ...
    public VariableHeightStructure(Structure.Config config,
    ...
    public Optional<Structure.StructurePosition> getStructurePosition(Structure.Context context) {
        ...
        if (!VariableHeightStructure.extraSpawningChecks(context)) {
    ...
    public StructureType<?> getType() {
        return ModStructures.VARIABLE_HEIGHT_STRUCTURE; // Helps the game know how to turn this structure back to json to save to chunks
    }
}